...
namespace InitialFramework.Reflection
{
    ...
    /// <summary>  
    /// <see cref="VariableMapperBase"/> 是所有映射器类的基类，提供了映射操作的基本框架和属性。  
    /// </summary>
    public abstract class VariableMapperBase : Traverser<KeyValuePair<VariableInfo, VariableInfo>, MappingPair>, IMapper
    {
        public virtual BindingFlags BindingAttr { get; }

        protected VariableMapperBase(BindingFlags bindingAttr = BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic) : base(FlowControl.Continue)
